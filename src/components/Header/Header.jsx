        ...
        <header className={classes.header + " " + classes.banner}>
            ...
            <span className={classes.navWrapper}>
                ...
                <span className={classes.loginBlock}>
                    ...
                    {props.isAuth ? <DropdownButton alignRight className={classes.dropdown} id="dropdown-menu-align-right" title={<span>{props.userName}<img className={classes.userIcon}
                        src={userIcon}
                        alt="user pic"
                    /></span>}>
                        <Dropdown.Item as="button">My profile</Dropdown.Item>
                        <Dropdown.Divider />
                        <Dropdown.Item as="button" onClick={() => { props.logOut() }}>Log out</Dropdown.Item>
                    </DropdownButton> : <span>
                            <NavLink to={'/login'}>
